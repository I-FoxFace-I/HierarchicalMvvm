...
//namespace HierarchicalMvvm.Generator1;
...
//        // Build namespace mapping for model types
...
//                    FullModelTypeName = GetFullModelTypeName(member.Type, namespaceMapping, propertyKind, collectionElementType)
//                });
//            }
//        }
...
//                {
//                    return namespaceMapping.TryGetValue(namedType.Name, out var fullName) ? fullName : $"{namedType.Name}Model";
//                }
//                break;
...
//                    return namespaceMapping.TryGetValue(elementTypeName, out var fullName) ? fullName : $"{elementTypeName}Model";
//                }
//                break;
//        }
...
//    {
//        var fieldName = $"_{char.ToLower(property.Name[0])}{property.Name[1..]}";
...
//            {
//                var elementModelType = GetSimpleTypeName(collection.FullModelTypeName ?? $"{collection.CollectionElementType}Model");
